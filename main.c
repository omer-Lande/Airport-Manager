...
int initManagerAndAirline(AirportManager* pManager, Airline* pCompany,char* airlineFileName,int compress)
{
	...
	if (res == FROM_FILE)
		return initAirlineFromFile(pCompany, pManager, airlineFileName,compress);
	else
